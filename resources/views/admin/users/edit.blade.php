            ...
            <div class="card">
                ...
                <div class="card-body">
                   ...
                   <form action="{{ route('admin.users.update', $user) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                @foreach ($roles as $role)
                                    <div class="form-check">
                                        <input type="checkbox" name="roles[]" class="" value="{{ $role->id }}" @if($user->roles->pluck('id')->contains($role->id)) checked @endif/>
                        ...
                        <button type="submit" class="btn btn-primary">Upate Roles</button>
                    </form>
